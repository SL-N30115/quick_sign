...
interface PDFPageCanvasProps {
    ...
    pageDimensions: Map<number, { width: number; height: number; pdfWidth: number; pdfHeight: number, scale?: number }>;
    setPageDimensions: React.Dispatch<React.SetStateAction<Map<number, {
        width: number;
        height: number;
        pdfWidth: number;
        pdfHeight: number,
                ...
                if (isMounted.current) {
                    setPageDimensions((prev) => {
                        ...
                        newMap.set(pageNumber, {
                            ...
                            scale: scale, // Store the current scale
                        });
                        return newMap;
                    });
                }
